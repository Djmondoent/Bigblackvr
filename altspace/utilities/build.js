...
gulp.task("altspace_js", () => {
  ...
  return (
    orderedMerge([
      ...
      rollup(build_configs.rollup).pipe(source("altspace.js")).pipe(buffer()),
    ])
...
gulp.task("compile-doc-index", ["del-doc"], () => {
  return gulp
    ...
    .pipe(
      prepend('<link rel="stylesheet" href="js/styles/jsdoc-default.css"/>\n')
    )
...
gulp.task(
  "version-docs",
  ["jsdoc-js", "jsdoc-aframe", "compile-doc-index"],
  () => {
    return gulp
      .src("../doc/**/*.html")
