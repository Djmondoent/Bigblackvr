  ...
  var t = {
    ...
    e = function(t) {
      return (
        ...
        (t = t.replace(/%([cd][0-9a-f])%([89ab][0-9a-f])/gi, function(t, r, o) {
...
(function(Url, Firebase$1, Please) {
  ...
  var AltspaceTrackedControls = (function(AFrameComponent$$1) {
    ...
    AltspaceTrackedControls.prototype.init = function init() {
      ...
      this.trackedControlsSystem = document.querySelector("a-scene").systems[
        "tracked-controls"
      ];
...
*/
  var AltspaceComponent = (function(AFrameComponent$$1) {
    ...
    AltspaceComponent.prototype.initRenderer = function initRenderer() {
      ...
      renderer.shadowMap = {};
      renderer.requestAnimationFrame = window.requestAnimationFrame.bind(
        window
      );
    };
  ...
  var SyncSystem = (function(AFrameSystem$$1) {
    ...
    SyncSystem.prototype.listenToInstantiationGroup = function listenToInstantiationGroup(
      snapshot
    ) {
    ...
    SyncSystem.prototype.stopListeningToInstantiationGroup = function stopListeningToInstantiationGroup(
      snapshot
    ) {
  ...
  var NativeComponent = (function(AFrameComponent$$1) {
    ...
    NativeComponent.prototype.callComponentAction = function callComponentAction(
      name
    ) {
      var args = [],
        len = arguments.length - 1;
  ...
  var Drag = (function(Behavior$$1) {
    ...
    Drag.prototype.moveDrag = function moveDrag(event) {
      ...
      var targetLocalPosition = this.object3d.parent.worldToLocal(
        targetWorldPosition
