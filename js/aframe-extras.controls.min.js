!(function e(t, o, i) {
...
})(
  {
        ...
        !(function (e) {
          ...
          function i(e) {
            var t = "keyCode" in e ? e.keyCode : "which" in e ? e.which : 0,
              o = (function () {
                if (m || "keyLocation" in e) {
                  var o = m ? e.location : e.keyLocation;
                  if (o && t in p[o]) return p[o][t];
                }
          ...
          var a = window.KeyboardEvent.DOM_KEY_LOCATION_STANDARD,
            c = window.KeyboardEvent.DOM_KEY_LOCATION_LEFT,
            s = window.KeyboardEvent.DOM_KEY_LOCATION_RIGHT,
            r = window.KeyboardEvent.DOM_KEY_LOCATION_NUMPAD,
            d = t(navigator.platform, "Win")
              ? "win"
            ...
            y = {
              ...
              91: { code: "OSLeft", location: c },
              92: { code: "OSRight", location: s },
              93: { code: "ContextMenu" },
              95: { code: "Standby" },
              ...
              145: { code: "ScrollLock" },
              160: { code: "ShiftLeft", location: c },
              161: { code: "ShiftRight", location: s },
              162: { code: "ControlLeft", location: c },
              163: { code: "ControlRight", location: s },
              164: { code: "AltLeft", location: c },
          ...
          o(y, "moz", {
            ...
            o(y, "moz-win", { 173: { code: "Minus", keyCap: "-" } }),
            o(y, "chrome-mac", { 93: { code: "OSRight", location: s } }),
            o(y, "safari", { 3: { code: "Enter" }, 25: { code: "Tab" } }),
            o(y, "ios", { 10: { code: "Enter", location: a } }),
            o(y, "safari-mac", {
              91: { code: "OSLeft", location: c },
              93: { code: "OSRight", location: s },
              229: { code: "KeyQ", keyCap: "Q" },
            });
          var u = {};
          "cros" === d &&
            ((u["U+00A0"] = { code: "ShiftLeft", location: c }),
            (u["U+00A1"] = { code: "ShiftRight", location: s }),
            (u["U+00A2"] = { code: "ControlLeft", location: c }),
            (u["U+00A3"] = { code: "ControlRight", location: s }),
            (u["U+00A4"] = { code: "AltLeft", location: c }),
            (u["U+00A5"] = { code: "AltRight", location: s })),
          ...
          var p = [];
          (p[c] = {
            16: { code: "ShiftLeft", location: c },
            17: { code: "ControlLeft", location: c },
            18: { code: "AltLeft", location: c },
          }),
            (p[s] = {
            ...
            o(p[c], "moz-mac", { 224: { code: "OSLeft", location: c } }),
            o(p[s], "moz-mac", { 224: { code: "OSRight", location: s } }),
            o(p[s], "moz-win", { 91: { code: "OSRight", location: s } }),
            o(p[s], "mac", { 93: { code: "OSRight", location: s } }),
            o(p[r], "chrome-mac", { 12: { code: "NumLock", location: r } }),
            o(p[r], "safari-mac", {
              12: { code: "NumLock", location: r },
          ...
          o(f, "mac", { OSLeft: { key: "Meta" }, OSRight: { key: "Meta" } });
          var v = {
              Esc: "Escape",
          ...
          try {
            var m = n && "location" in new KeyboardEvent("");
          } catch (e) {}
          "KeyboardEvent" in e &&
            "defineProperty" in Object &&
            (function () {
              function e(e, t, o) {
                t in e || Object.defineProperty(e, t, o);
              }
              if (
              ...
              e(KeyboardEvent.prototype, "key", {
                ...
                e(KeyboardEvent.prototype, "location", {
                  get: function () {
                    var e = i(this);
                    return e && "location" in e ? e.location : a;
                  },
                }),
            ...
            "queryKeyCap" in e.KeyboardEvent ||
              (e.KeyboardEvent.queryKeyCap = function (e, t) {
                if (((e = String(e)), !k.hasOwnProperty(e))) return "Undefined";
        ...
        t.exports = AFRAME.registerComponent("checkpoint-controls", {
          ...
          getVelocity: function () {
            if (this.active) {
              ...
              return (
                ...
                o.distanceTo(i) < 0.1
                  ? ((this.checkpoint = null),
                    this.el.emit("navigation-end", { checkpoint: n }),
                    t.set(0, 0, 0))
          ...
          sync: function () {
            ...
            t.copy(this.el.getAttribute("position")),
              this.checkpoint.object3D.getWorldPosition(o),
              o.add(this.checkpoint.components.checkpoint.getOffset()),
              e.copy(o).sub(t);
          },
        });
      },
    ...
    6: [
      function (e, t, o) {
        "use strict";
        var i = e("../../lib/GamepadButton"),
          n = e("../../lib/GamepadButtonEvent"),
          a = { LEFT: "left", RIGHT: "right" },
          c = { MOVEMENT: 1, ROTATION: 2 };
        t.exports = AFRAME.registerComponent("gamepad-controls", {
          ...
          isVelocityActive: function () {
            ...
            var e = this._dpadVector,
              t = this._moveVector;
            this.getDpad(e), this.getJoystick(c.MOVEMENT, t);
            var o = e.x || t.x,
              i = e.y || t.y;
            return Math.abs(o) > 0.2 || Math.abs(i) > 0.2;
          },
          getVelocityDelta: function () {
            ...
            var o = e.x || t.x,
              ...
              n = new THREE.Vector3();
            return (
              Math.abs(o) > 0.2 && (n.x += o),
              Math.abs(i) > 0.2 && (n.z += i),
              n
            );
          },
          isRotationActive: function () {
            if (!this.data.enabled || !this.isConnected()) return !1;
            var e = this._lookVector;
            return (
              this.getJoystick(c.ROTATION, e),
              Math.abs(e.x) > 0.2 || Math.abs(e.y) > 0.2
            );
          },
          updateRotation: function (e) {
            if (this.isRotationActive()) {
              var t = this.data,
                o = this.yaw,
                i = this.pitch,
                n = t.camera.components["look-controls"],
                a = n && n.pitchObject && n.yawObject;
              a &&
                (i.rotation.copy(n.pitchObject.rotation),
                o.rotation.copy(n.yawObject.rotation));
              var s = this._lookVector;
              this.getJoystick(c.ROTATION, s),
                Math.abs(s.x) <= 0.2 && (s.x = 0),
                Math.abs(s.y) <= 0.2 && (s.y = 0),
                s.multiplyScalar((t.rotationSensitivity * e) / 1e3),
                (o.rotation.y -= s.x),
                (i.rotation.x -= s.y),
                (i.rotation.x = Math.max(
                  -Math.PI / 2,
                  Math.min(Math.PI / 2, i.rotation.x)
                )),
                t.camera.object3D.rotation.set(i.rotation.x, o.rotation.y, 0),
                a &&
                  (n.pitchObject.rotation.copy(i.rotation),
                  n.yawObject.rotation.copy(o.rotation));
            }
          },
          updateButtonState: function () {
            var e = this.getGamepad(a.RIGHT);
            if (this.data.enabled && e)
              for (var t = 0; t < e.buttons.length; t++)
                e.buttons[t].pressed && !this.buttons[t]
                  ? this.emit(new n("gamepadbuttondown", t, e.buttons[t]))
                  : !e.buttons[t].pressed &&
                    this.buttons[t] &&
                    this.emit(new n("gamepadbuttonup", t, e.buttons[t])),
                  (this.buttons[t] = e.buttons[t].pressed);
            else Object.keys(this.buttons) && (this.buttons = {});
          },
          emit: function (e) {
            this.el.emit(e.type, e),
              this.el.emit(e.type + ":" + e.index, new n(e.type, e.index, e));
          },
          getGamepad: (function () {
            var e = [],
              t = [];
            return function (o) {
              var i = this.el.sceneEl.components["proxy-controls"],
                n = i && i.isConnected() && i.getGamepad(0);
              if (n) return n;
              e.length = 0;
              for (var a = 0; a < this.system.controllers.length; a++) {
                var c = this.system.controllers[a],
                  s = c ? c.gamepad : null;
                if ((e.push(s), s && c.handedness === o)) return s;
              }
              for (
                var r = navigator.getGamepads ? navigator.getGamepads() : t,
                  d = 0;
                d < r.length;
                d++
              ) {
                var h = r[d];
                if (h && h.hand === o) return h;
              }
              return e[0] || r[0];
            };
          })(),
          getButton: function (e) {
            return this.getGamepad(a.RIGHT).buttons[e];
          },
          getAxis: function (e) {
            return this.getGamepad(e > 1 ? a.RIGHT : a.LEFT).axes[e];
          },
          getJoystick: function (e, t) {
            var o = this.getGamepad(e === c.MOVEMENT ? a.LEFT : a.RIGHT);
            if ("xr-standard" === o.mapping)
              switch (e) {
                case c.MOVEMENT:
                  return t.set(o.axes[2], o.axes[3]);
                case c.ROTATION:
                  return t.set(o.axes[0], o.axes[1]);
              }
            else
              switch (e) {
                case c.MOVEMENT:
          ...
          getDpad: function (e) {
            var t = this.getGamepad(a.LEFT);
            return t.buttons[i.DPAD_RIGHT]
              ? e.set(
                  (t.buttons[i.DPAD_RIGHT].pressed ? 1 : 0) +
                    (t.buttons[i.DPAD_LEFT].pressed ? -1 : 0),
                  (t.buttons[i.DPAD_UP].pressed ? -1 : 0) +
                    (t.buttons[i.DPAD_DOWN].pressed ? 1 : 0)
                )
              : e.set(0, 0);
          },
          isConnected: function () {
            var e = this.getGamepad(a.LEFT);
            return !(!e || !e.connected);
          },
          getID: function () {
            return this.getGamepad(a.LEFT).id;
          },
        });
      },
      { "../../lib/GamepadButton": 2, "../../lib/GamepadButtonEvent": 3 },
    ],
    7: [
      function (e, t, o) {
        "use strict";
      ...
      {
        "./checkpoint-controls": 5,
        "./gamepad-controls": 6,
        "./keyboard-controls": 8,
        "./movement-controls": 9,
        "./touch-controls": 10,
        "./trackpad-controls": 11,
      },
    ],
    8: [
      function (e, t, o) {
        ...
        t.exports = AFRAME.registerComponent("keyboard-controls", {
          ...
          emit: function (e) {
            "__keyboard-controls-proxy" in e && this.el.emit(e.type, e),
              this.el.emit(e.type + ":" + e.code, new i(e.type, e)),
      ...
      function (e, t, o) {
        ...
        t.exports = AFRAME.registerComponent("movement-controls", {
          ...
          update: function (e) {
            var t = this.el,
              o = this.data,
              i = t.sceneEl.systems.nav;
            t.sceneEl.hasLoaded && this.injectControls(),
              i &&
                o.constrainToNavMesh !== e.constrainToNavMesh &&
                (o.constrainToNavMesh ? i.addAgent(this) : i.removeAgent(this));
          },
          injectControls: function () {
            for (var e, t = this.data, o = 0; o < t.controls.length; o++)
              (e = t.controls[o] + "-controls"),
            ...
            return function (i, n) {
              if (n) {
                ...
                if (c.enabled) {
                  ...
                  var s = this.velocityCtrl,
                    r = this.velocity;
                  if (s)
                    if (
                      (n / 1e3 > 0.2 ? r.set(0, 0, 0) : this.updateVelocity(n),
                      c.constrainToNavMesh && !1 !== s.isNavMeshConstrained)
                    ) {
                      if (r.lengthSq() < 1e-5) return;
                      e.copy(a.object3D.position),
                        t
                          .copy(r)
                          .multiplyScalar(n / 1e3)
                          .add(e);
                      var d = a.sceneEl.systems.nav;
                      (this.navGroup =
                        null === this.navGroup ? d.getGroup(e) : this.navGroup),
                        (this.navNode =
                          this.navNode || d.getNode(e, this.navGroup)),
                        (this.navNode = d.clampStep(
                          e,
                          t,
                          this.navGroup,
                          this.navNode,
                      ...
                      a.hasAttribute("velocity")
                        ? a.setAttribute("velocity", r)
                        : ((a.object3D.position.x += (r.x * n) / 1e3),
                          (a.object3D.position.y += (r.y * n) / 1e3),
                          (a.object3D.position.z += (r.z * n) / 1e3));
                }
              }
            };
          })(),
          updateVelocityCtrl: function () {
            var e = this.data;
            if (e.enabled) {
              for (var t = 0, o = e.controls.length; t < o; t++) {
                var i = this.el.components[e.controls[t] + "-controls"];
                if (i && i.isVelocityActive())
                  return void (this.velocityCtrl = i);
              }
              this.velocityCtrl = null;
            }
          },
          updateVelocity: (function () {
            ...
            return function (o) {
              var i = void 0,
                ...
                s = this.data;
              if (a) {
                if (!a.getVelocityDelta) {
                  if (a.getVelocity) return void c.copy(a.getVelocity());
                  if (a.getPositionDelta)
                    return void c.copy(
                      a.getPositionDelta(o).multiplyScalar(1e3 / o)
                    );
                  throw new Error("Incompatible movement controls: ", a);
                }
                i = a.getVelocityDelta(o);
              }
              if (
                (n.hasAttribute("velocity") &&
                  !s.constrainToNavMesh &&
                  c.copy(this.el.getAttribute("velocity")),
                i && s.enabled)
              ) {
                var r = s.camera;
                t.copy(r.object3D.quaternion),
                  t.premultiply(n.object3D.quaternion),
                  i.applyQuaternion(t);
                var d = i.length();
                s.fly
                  ? (c.copy(i), c.multiplyScalar(16.66667 * this.data.speed))
                  : (e.set(i.x, i.z),
                    e.setLength(d * this.data.speed * 16.66667),
                    (c.x = e.x),
                    (c.z = e.y));
              }
            };
        ...
        t.exports = AFRAME.registerComponent("trackpad-controls", {
          ...
          handleSwipeAxis: function (e) {
            ...
            if (
              (0 === this.startingAxisData.length &&
                ...
                (this.startingAxisData[0] = o[0]),
                (this.startingAxisData[1] = o[1])),
              this.startingAxisData.length > 0)
            ) {
              var i = 0,
                n = 0;
              t.enableNegX && o[0] < this.startingAxisData[0] && (i = -1),
                t.enablePosX && o[0] > this.startingAxisData[0] && (i = 1),
                t.enablePosZ && o[1] > this.startingAxisData[1] && (n = -1),
                t.enableNegZ && o[1] < this.startingAxisData[1] && (n = 1);
              var a = Math.abs(this.startingAxisData[1] - o[1]);
              Math.abs(this.startingAxisData[0] - o[0]) > a
                ? ((this.zVel = 0), (this.xVel = i), (this.isMoving = !0))
          ...
          handleTouchAxis: function (e) {
            var t = this.data,
              ...
              i = 0,
              n = 0;
            t.enableNegX && o[0] < 0 && (i = -1),
              t.enablePosX && o[0] > 0 && (i = 1),
              t.enablePosZ && o[1] > 0 && (n = -1),
              t.enableNegZ && o[1] < 0 && (n = 1),
              Math.abs(o[0]) > Math.abs(o[1])
                ? ((this.zVel = 0), (this.xVel = i))
                : ((this.xVel = 0), (this.zVel = n));
          },
        });
      },
      {},
