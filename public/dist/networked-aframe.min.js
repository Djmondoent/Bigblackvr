!(function(e) {
    ...
    (e.exports.whenEntityLoaded = function(e, t) {
      ...
      (e.exports.getNetworkedEntity = function(e) {
        return new Promise(function(t, n) {
          for (var i = e; i && i.components && !i.components.networked; )
            i = i.parentNode;
          if (!i || !i.components || !i.components.networked)
            return n(
              "Entity does not have and is not a child of an entity with the [networked] component "
            );
          i.hasLoaded
            ? t(i)
            : i.addEventListener(
      ...
      (e.exports.takeOwnership = function(e) {
        for (var t = e; t && t.components && !t.components.networked; )
          t = t.parentNode;
        if (!t || !t.components || !t.components.networked)
          throw new Error(
            "Entity does not have and is not a child of an entity with the [networked] component "
          );
      ...
      (e.exports.isMine = function(e) {
        ...
        return (
          !!t.components.networked.data &&
          t.components.networked.data.owner === NAF.clientId
        );
      }),
        ...
        (n = [
          {
            ...
            value: function(e) {
              return { template: e, components: ["position", "rotation"] };
            }
          },
          {
            key: "add",
            value: function(e) {
              if (this.validateSchema(e)) {
                ...
                if (!t)
                  return void NAF.log.error(
                    "Template el not found for ".concat(
                      e.template,
                      ", make sure NAF.schemas.add is called after <a-scene> is defined."
                    )
                  );
                if (!this.validateTemplate(e, t)) return;
                this.templateCache[e.template] = document.importNode(
                  t.content,
                  !0
                );
              } else
                NAF.log.error("Schema not valid: ", e),
                  NAF.log.error(
          ...
          },
          {
            ...
            value: function(e) {
              return (
                this.templateIsCached(e) ||
                  (this.templateExistsInScene(e)
                    ? this.add(this.createDefaultSchema(e))
                    : NAF.log.error(
                        "Template el for ".concat(
                          e,
                          " is not in the scene, add the template to <a-assets> and register with NAF.schemas.add."
                        )
                      )),
                this.templateCache[e].firstElementChild.cloneNode(!0)
              );
            }
          },
          {
          ...
          },
          {
            ...
            value: function(e) {
              ...
              return (
                this.hasTemplate(e) && (t = this.schemaDict[e].components), t
              );
            }
          },
          {
          ...
          },
          {
            ...
            value: function(e, t) {
              return this.isTemplateTag(t)
                ? !!this.templateHasOneOrZeroChildren(t) ||
                    (NAF.log.error(
                      "Template for ".concat(
                        e.template,
                        " has more than one child. Templates must have one direct child element, no more. Template found:"
                      ),
                      t
                    ),
                    !1)
                : (NAF.log.error(
                    "Template for "
                      .concat(
                        e.template,
                        " is not a <template> tag. Instead found: "
                      )
                      .concat(t.tagName)
                  ),
                  !1);
          ...
          (n = [
            ...
            },
            {
              ...
              value: function(e) {
                ...
                return (
                  this.initPosition(n, e.components),
                  this.initRotation(n, e.components),
                  this.addNetworkComponent(n, e),
                  this.registerEntity(t, n),
                  n
                );
              }
            },
            ...
            },
            {
              ...
              value: function(e, t, n, i) {
                if (!NAF.options.syncSource || i === NAF.options.syncSource)
                  for (var o = 0, r = n.d.length; o < r; o++)
                    this.updateEntity(e, "u", n.d[o], i);
              }
            },
            {
              key: "updateEntity",
              value: function(e, t, n, i) {
                if (!NAF.options.syncSource || i === NAF.options.syncSource) {
                  var o = n.networkId;
                  this.hasEntity(o)
                    ? this.entities[o].components.networked.networkUpdate(n)
                    : n.isFirstSync &&
                      !1 !== NAF.connection.activeDataChannels[n.owner] &&
                      (NAF.options.firstSyncSource &&
                      i !== NAF.options.firstSyncSource
                        ? NAF.log.write(
                            "Ignoring first sync from disallowed source",
                            i
                          )
                        : n.persistent
                        ? (this._persistentFirstSyncs[o] = n)
                        : this.receiveFirstUpdateFromEntity(n));
                }
              }
            },
            {
              ...
              value: function(e) {
                ...
                if (t && !this.hasEntity(t)) this.childCache.addChild(t, e);
                  ...
                  this.createAndAppendChildren(n, i),
                    this.addEntityToPage(i, t);
                }
              }
            },
            {
              ...
              value: function(e, t) {
                for (
                  var n = this.childCache.getChildren(e), i = 0;
                  i < n.length;
                  i++
                ) {
                  var o = n[i],
                  ...
                  if (this.hasEntity(r))
                    ...
                    var s = this.createRemoteEntity(o);
                    this.createAndAppendChildren(r, s), t.appendChild(s);
                  }
                }
              }
            },
            {
              ...
              value: function(e, t) {
                this.hasEntity(t)
                  ? this.addEntityToParent(e, t)
                  : this.addEntityToSceneRoot(e);
              }
            },
            {
              key: "addEntityToParent",
              value: function(e, t) {
                this.entities[t].appendChild(e);
              }
            },
            {
            ...
            },
            {
              ...
              value: function(e, t) {
                for (var n in this.entities)
                  this.entities[n] &&
                    this.entities[n].components.networked.syncAll(e, t);
              }
            },
            {
              ...
              value: function(e) {
                ...
                for (var n in this.entities) {
                  var i = this.entities[n],
                    o = NAF.utils.getCreator(i),
                    r = NAF.utils.getNetworkOwner(i);
                  if (o === e || (!o && r === e)) {
                    var s = this.entities[n].getAttribute("networked");
                    s && s.persistent
                      ? NAF.utils.takeOwnership(i)
                      : t.push(this.removeEntity(n));
                  }
                }
                return t;
              }
            },
            {
              ...
              value: function(e) {
                ...
                return (
                  NAF.log.error("Tried to remove entity I don't have."), null
                );
              }
            },
            {
            ...
            },
            {
              ...
              value: function() {
                for (var e in ((this.childCache = new o()), this.entities))
                  this.entities[e].getAttribute("networked").owner !=
                    NAF.clientId && this.removeEntity(e);
              }
            }
          ]) && i(t.prototype, n),
          r && i(t, r),
          ...
          (n = [
            ...
            },
            {
              ...
              value: function() {
                (this.dataChannelSubs = {}),
                  (this.dataChannelSubs[o] = this.entities.updateEntity.bind(
                    this.entities
                  )),
                  (this.dataChannelSubs[
                    r
            ...
            },
            {
              ...
              value: function(e, t, n) {
                ...
                (NAF.app = t),
                  (NAF.room = n),
                  this.adapter.setServerUrl(e),
                  this.adapter.setApp(t),
                  this.adapter.setRoom(n);
                var r = { audio: i, video: o, datachannel: !0 };
                return (
                  this.adapter.setWebRtcOptions(r),
                  ...
                  this.adapter.setRoomOccupantListener(
                    this.occupantsReceived.bind(this)
                  ),
            ...
            },
            {
              ...
              value: function(e) {
                (this.onConnectCallback = e),
                  this.isConnected()
                    ? e()
                    : document.body.addEventListener("connected", e, !1);
              }
            },
            {
              key: "connectSuccess",
              value: function(e) {
                NAF.log.write("Networked-Aframe Client ID:", e),
                  (NAF.clientId = e);
            ...
            },
            {
              ...
              value: function(e) {
                ...
                (this.connectedClients = e),
                  this.checkForDisconnectingClients(t, e),
                  this.checkForConnectingClients(e);
              }
            },
            {
              ...
              value: function(e, t) {
                for (var n in e)
                  t[n] ||
                    (NAF.log.write("Closing stream to ", n),
                    this.adapter.closeStreamConnection(n));
              }
            },
            {
              ...
              value: function(e) {
                for (var t in e)
                  this.isNewClient(t) &&
                    this.adapter.shouldStartConnectionTo(e[t]) &&
                    (NAF.log.write("Opening datachannel to ", t),
                    this.adapter.startStreamConnection(t));
              }
            },
            {
            ...
            },
            {
              ...
              value: function(e) {
                return (
                  this.adapter.getConnectStatus(e) === NAF.adapters.IS_CONNECTED
                );
              }
            },
            {
              key: "dataChannelOpen",
              value: function(e) {
                NAF.log.write("Opened data channel from " + e),
                  (this.activeDataChannels[e] = !0),
                  this.entities.completeSync(e, !0);
            ...
            },
            {
              ...
              value: function(e) {
                NAF.log.write("Closed data channel from " + e),
                  (this.activeDataChannels[e] = !1),
                  this.entities.removeEntitiesOfClient(e);
            ...
            },
            {
              ...
              value: function(e) {
                return !!this.activeDataChannels[e];
              }
            },
            {
              key: "broadcastData",
            ...
            },
            {
              key: "sendData",
              value: function(e, t, n, i) {
                this.hasActiveDataChannel(e) &&
                  (i
                    ? this.adapter.sendDataGuaranteed(e, t, n)
                    : this.adapter.sendData(e, t, n));
              }
            },
            {
              key: "sendDataGuaranteed",
            ...
            },
            {
              key: "receivedData",
              value: function(e, t, n, i) {
                this.dataChannelSubs[t]
                  ? this.dataChannelSubs[t](e, t, n, i)
                  : NAF.log.write(
            ...
            },
            {
              ...
              value: function() {
                this.entities.removeRemoteEntities(),
                  this.adapter && this.adapter.disconnect(),
                  (NAF.app = ""),
                  (NAF.room = ""),
                  (NAF.clientId = ""),
                  (this.connectedClients = {}),
      ...
      c = (function() {
        function e() {
          !(function(e, t) {
            ...
            (this.IS_CONNECTED = e.IS_CONNECTED),
            (this.CONNECTING = e.CONNECTING),
            (this.NOT_CONNECTED = e.NOT_CONNECTED);
        }
        var t, n, c;
        return (
          (t = e),
    ...
    var h = (function(e) {
      ...
      function u(e) {
        ...
        return (
          ...
          ((t = r.call(this)).easyrtc = e || window.easyrtc),
          (t.app = "default"),
          (t.room = "default"),
          (t.connectedClients = []),
          (t.serverTimeRequests = 0),
          (t.timeOffsets = []),
          (t.avgTimeOffset = 0),
          t
        );
        ...
        (n = [
          {
            key: "setServerUrl",
            value: function(e) {
              (this.serverUrl = e), this.easyrtc.setSocketUrl(e);
            }
          },
          {
            key: "setApp",
          ...
          },
          {
            key: "setRoom",
            value: function(e) {
              (this.room = e), this.easyrtc.joinRoom(e, null);
            }
          },
          { key: "setWebRtcOptions", value: function(e) {} },
          {
            key: "setServerConnectListeners",
            value: function(e, t) {
          ...
          },
          {
            key: "setRoomOccupantListener",
            value: function(e) {
              this.easyrtc.setRoomOccupantListener(function(t, n, i) {
                e(n);
              });
            }
          },
          {
            ...
            value: function(e, t, n) {
              (this.openListener = e),
                (this.closedListener = t),
                this.easyrtc.setPeerListener(n);
            }
          },
          {
            ...
            value: function() {
              ...
              return fetch(document.location.href, {
                ...
                var i = new Date(n.headers.get("Date")).getTime() + 500,
                  o = Date.now(),
                  r = i + (o - t) / 2 - o;
                e.serverTimeRequests++,
                  e.serverTimeRequests <= 10
                    ? e.timeOffsets.push(r)
                    : (e.timeOffsets[e.serverTimeRequests % 10] = r),
                  (e.avgTimeOffset =
                    e.timeOffsets.reduce(function(e, t) {
                      return e + t;
                    }, 0) / e.timeOffsets.length),
                  e.serverTimeRequests > 10
                    ? setTimeout(function() {
          ...
          },
          {
            key: "closeStreamConnection",
            value: function(e) {
              var t = this.connectedClients.indexOf(e);
              t > -1 && this.connectedClients.splice(t, 1),
          ...
          },
          {
            key: "broadcastData",
            value: function(e, t) {
              var n = { targetRoom: this.room };
              this.easyrtc.sendDataWS(n, e, t);
            }
          },
          {
            key: "broadcastDataGuaranteed",
            value: function(e, t) {
              this.broadcastData(e, t);
            }
          },
          {
            key: "getConnectStatus",
            value: function(e) {
              return -1 != this.connectedClients.indexOf(e)
        ...
        (n = [
          {
            key: "notImplemented",
            value: function(e) {
              NAF.log.error("Interface method not implemented:", e);
            }
          }
        ]) && i(t.prototype, n),
        o && i(t, o),
    ...
    var h = (function(e) {
      ...
      function u(e) {
        ...
        return (
          ...
          (t.room = "default"),
          (t.mediaStreams = {}),
          (t.pendingMediaRequests = new Map()),
          (t.serverTimeRequests = 0),
          (t.timeOffsets = []),
          (t.avgTimeOffset = 0),
          t
      ...
      return (
        ...
        (n = [
          ...
          },
          {
            key: "setWebRtcOptions",
            value: function(e) {
              this.easyrtc.enableDataChannels(e.datachannel),
                this.easyrtc.enableVideo(e.video),
                this.easyrtc.enableAudio(e.audio),
                this.easyrtc.enableVideoReceive(!0),
                this.easyrtc.enableAudioReceive(!0);
            }
          },
          {
            key: "setServerConnectListeners",
          ...
          },
          {
            key: "setDataChannelListeners",
            value: function(e, t, n) {
              this.easyrtc.setDataChannelOpenListener(e),
                this.easyrtc.setDataChannelCloseListener(t),
                this.easyrtc.setPeerListener(n);
            }
          },
          {
            ...
            value: function() {
              ...
              Promise.all([
                ...
                .then(function(t) {
                  var n = o(t, 2),
                    i = (n[0], n[1]);
                  (e._myRoomJoinTime = e._getRoomJoinTime(i)),
                    e.connectSuccess(i);
                })
                .catch(this.connectFailure);
            }
          },
          {
            key: "shouldStartConnectionTo",
            value: function(e) {
              return this._myRoomJoinTime <= e.roomJoinTime;
            }
          },
          {
            key: "startStreamConnection",
            value: function(e) {
              this.easyrtc.call(
                ...
                function(e, t) {
                  "datachannel" === t &&
                    NAF.log.write("Successfully started datachannel to ", e);
                },
                function(e, t) {
                  NAF.log.error(e, t);
                },
          ...
          { key: "closeStreamConnection", value: function(e) {} },
          {
            key: "sendData",
            value: function(e, t, n) {
              this.easyrtc.sendData(e, t, n);
            }
          },
          {
            key: "sendDataGuaranteed",
          ...
          },
          {
            key: "broadcastData",
            value: function(e, t) {
              var n = this.easyrtc.getRoomOccupantsAsMap(this.room);
              for (var i in n)
                n[i] &&
                  i !== this.easyrtc.myEasyrtcid &&
                  this.easyrtc.sendData(i, e, t);
            }
          },
          {
            key: "broadcastDataGuaranteed",
          ...
          },
          {
            key: "getConnectStatus",
            value: function(e) {
              var t = this.easyrtc.getConnectStatus(e);
              return t == this.easyrtc.IS_CONNECTED
                ? NAF.adapters.IS_CONNECTED
                : t == this.easyrtc.NOT_CONNECTED
                ? NAF.adapters.NOT_CONNECTED
              ...
              var t = this,
                n =
                  arguments.length > 1 && void 0 !== arguments[1]
                    ? arguments[1]
                    : "audio";
              if (this.mediaStreams[e])
                return (
                  NAF.log.write("Already had ".concat(n, " for ").concat(e)),
                  Promise.resolve(this.mediaStreams[e][n])
                );
              if (
                (NAF.log.write("Waiting on ".concat(n, " for ").concat(e)),
                !this.pendingMediaRequests.has(e))
              ) {
                this.pendingMediaRequests.set(e, {});
                var i = new Promise(function(n, i) {
                    t.pendingMediaRequests.get(e).audio = {
                      resolve: n,
                      reject: i
                    };
                  }),
                  o = new Promise(function(n, i) {
                    t.pendingMediaRequests.get(e).video = {
                      resolve: n,
                      reject: i
                    };
                  });
                (this.pendingMediaRequests.get(e).audio.promise = i),
                  (this.pendingMediaRequests.get(e).video.promise = o),
                  i.catch(function(t) {
                    return NAF.log.warn(
                      "".concat(e, " getMediaStream Audio Error"),
                      t
                    );
                  }),
                  o.catch(function(t) {
                    return NAF.log.warn(
                      "".concat(e, " getMediaStream Video Error"),
                      t
                    );
                  });
              }
              return this.pendingMediaRequests.get(e)[n].promise;
            }
          },
          {
            key: "setMediaStream",
            value: function(e, t) {
              ...
              try {
                ...
                NAF.log.warn("".concat(e, " setMediaStream Audio Error"), t);
              }
              ...
              try {
                ...
                NAF.log.warn("".concat(e, " setMediaStream Video Error"), t);
              }
              (this.mediaStreams[e] = { audio: n, video: i }),
                this.pendingMediaRequests.has(e) &&
                  (this.pendingMediaRequests.get(e).audio.resolve(n),
                  this.pendingMediaRequests.get(e).video.resolve(i));
            }
          },
          {
            key: "enableMicrophone",
            value: function(e) {
              this.easyrtc.enableMicrophone(e);
            }
          },
          {
            key: "enableCamera",
            value: function(e) {
              this.easyrtc.enableCamera(e);
            }
          },
          {
            key: "disconnect",
          ...
          },
          {
            ...
            value: function(e, t) {
              ...
              this.easyrtc.setStreamAcceptor(this.setMediaStream.bind(this)),
                this.easyrtc.setOnStreamClosed(function(e) {
                  delete n.mediaStreams[e];
                }),
                n.easyrtc.audioEnabled || n.easyrtc.videoEnabled
                  ? this.easyrtc.initMediaSource(
                      function(i) {
                        n.setMediaStream(n.easyrtc.myEasyrtcid, i),
                          n.easyrtc.connect(n.app, e, t);
                      },
                      function(e, t) {
                        NAF.log.error(e, t);
                      }
          ...
          },
          {
            ...
            value: function(e) {
              var t = NAF.room;
              return this.easyrtc.getRoomOccupantsAsMap(t)[e].roomJoinTime;
            }
          },
          {
            key: "getServerTime",
        ...
        r(e, [
          ...
          },
          {
            ...
            value: function(e) {
              var t = this;
              this.setupChannel(
                this.pc.createDataChannel(this.channelLabel, { reliable: !1 })
              ),
                e.sendAudio &&
                  e.localAudioStream.getTracks().forEach(function(n) {
          ...
          },
          {
            key: "handleSignal",
            value: function(e) {
              if (this.localId === e.to && this.remoteId === e.from)
                switch (e.type) {
                  case "offer":
                    this.handleOffer(e);
                    break;
                  ...
                  default:
                    NAF.log.error(
                      "WebRtcPeer.handleSignal: Unknown signal type " + e.type
                    );
                }
            }
          },
          {
            ...
            value: function(e, t) {
              null !== this.channel &&
                "open" === this.channel.readyState &&
                this.channel.send(JSON.stringify({ type: e, data: t }));
            }
          },
          {
            key: "getStatus",
          ...
          },
          {
            ...
            value: function() {
              ...
              var i = new n({ iceServers: e.ICE_SERVERS });
              return (
                ...
                (i.oniceconnectionstatechange = function() {
                  t.open &&
                    ...
                    ((t.open = !1), t.closedListener(t.remoteId));
                }),
    ...
    var a = (function() {
      function e() {
        i(this, e),
          void 0 === io &&
            console.warn(
              "It looks like socket.io has not been loaded before WebrtcAdapter. Please do that."
            ),
          (this.app = "default"),
          (this.room = "default"),
      ...
      return (
        r(e, [
              ...
              this.updateTimeOffset().then(function() {
                (e.wsUrl && "/" !== e.wsUrl) ||
                  ("https:" === location.protocol
                    ? (e.wsUrl = "wss://" + location.host)
                    : (e.wsUrl = "ws://" + location.host)),
                ...
                function n(t) {
                  ...
                  "ice-candidate" !== i
                    ...
                    : e.peers[n].handleSignal(o);
                }
                t.on("connect", function() {
                  NAF.log.write("User connected", t.id),
                    (e.myId = t.id),
                    e.joinRoom();
                }),
                  t.on("connectSuccess", function(t) {
                    ...
                    if (
                      ...
                      navigator.mediaDevices
                        ...
                        .then(function(t) {
                          e.storeAudioStream(e.myId, t),
                            e.connectSuccess(e.myId),
                            t.getTracks().forEach(function(n) {
                              Object.keys(e.peers).forEach(function(i) {
                                e.peers[i].pc.addTrack(n, t);
                              });
                            });
                        })
                        .catch(function(t) {
                          NAF.log.error(t),
                            console.error(
                              "Microphone is disabled due to lack of permissions"
                            ),
                            (e.sendAudio = !1),
                            e.connectSuccess(e.myId);
                        });
                  ...
                  t.on("error", function(t) {
                    console.error("Socket connection failure", t),
                      e.connectFailure();
                  }),
                  t.on("occupantsChanged", function(t) {
                    var n = t.occupants;
                    NAF.log.write("occupants changed", t),
                      e.receivedOccupants(n);
                  }),
                  t.on("send", n),
                  t.on("broadcast", n);
              });
          ...
          },
          {
            ...
            value: function(e) {
              ...
              var n = this,
                ...
                o = function(e) {
                  var o = e;
                  if (t.peers[o]) return "continue";
                  var r = new s(i, o, function(e) {
                    n.socket.emit("send", {
                      from: i,
                      to: o,
                      type: "ice-candidate",
                  ...
                  r.setDatachannelListeners(
                    n.openListener,
                    n.closedListener,
                    n.messageListener,
                    n.trackListener.bind(n)
                  ),
                    (n.peers[o] = r);
                };
              for (var r in e) o(r);
          ...
          },
          {
            ...
            value: function(e) {
              ...
              NAF.log.write("starting offer process"),
                this.sendAudio
                  ? this.getMediaStream(this.myId).then(function(n) {
                      var i = { sendAudio: !0, localAudioStream: n };
                      t.peers[e].offer(i);
                    })
                  : this.peers[e].offer({});
            }
          },
          {
            key: "closeStreamConnection",
            value: function(e) {
              NAF.log.write("closeStreamConnection", e, this.peers),
                this.peers[e].close(),
                delete this.peers[e],
                delete this.occupants[e],
                this.closedListener(e);
            }
          },
          {
          ...
          },
          {
            key: "sendDataGuaranteed",
            value: function(e, t, n) {
              var i = { from: this.myId, to: e, type: t, data: n, sending: !0 };
          ...
          },
          {
            key: "broadcastDataGuaranteed",
            value: function(e, t) {
              var n = { from: this.myId, type: e, data: t, broadcasting: !0 };
          ...
          },
          {
            ...
            value: function(e, t) {
              (this.audioStreams[e] = t),
                this.pendingAudioRequest[e] &&
                  (NAF.log.write("Received pending audio for " + e),
                  this.pendingAudioRequest[e](t),
                  this.pendingAudioRequest[e](t));
            }
          },
          {
          ...
          },
          {
            ...
            value: function(e) {
              var t = this;
              return this.audioStreams[e]
                ? (NAF.log.write("Already had audio for " + e),
                  Promise.resolve(this.audioStreams[e]))
                : (NAF.log.write("Waiting on audio for " + e),
      ...
      return (
        ...
        (n = [
          ...
          },
          {
            key: "closeStreamConnection",
            value: function(e) {
              (this.connectedClients = this.connectedClients.filter(function(
                t
              ) {
                return t != e;
              })),
          ...
          { key: "getMediaStream", value: function(e) {} },
          {
            key: "updateTimeOffset",
            value: function() {
              var e = this,
    ...
    AFRAME.registerComponent("networked-scene", {
      ...
      init: function() {
        ...
        (this.connect = this.connect.bind(this)),
          e.addEventListener("connect", this.connect),
          this.data.connectOnLoad && e.emit("connect", null, !1);
      },
      connect: function() {
        return (
          ...
          this.hasOnConnectFunction() && this.callOnConnect(),
      ...
      setupNetworkAdapter: function() {
        ...
        NAF.connection.setNetworkAdapter(t),
          this.el.emit("adapter-ready", t, !1);
      },
    ...
    AFRAME.registerSystem("networked", {
      ...
      tick: function() {
        if (
          ...
          !(this.el.clock.elapsedTime < this.nextSyncTime)
        ) {
          for (
            var e = { d: [] }, t = 0, n = this.components.length;
            t < n;
            t++
          ) {
            var i = this.components[t];
            if (i.isMine()) {
              if (!i.el.parentElement)
                return void NAF.log.error(
                  "entity registered with system despite being removed"
                );
              var o = this.components[t].syncDirty();
              o && e.d.push(o);
            }
          }
          e.d.length > 0 && NAF.connection.broadcastData("um", e),
            this.updateNextSyncTime();
        }
      },
      updateNextSyncTime: function() {
        this.nextSyncTime =
          this.el.clock.elapsedTime + 1 / NAF.options.updateRate;
      }
    }),
      AFRAME.registerComponent("networked", {
        schema: {
          template: { default: "" },
          attachTemplateToLocal: { default: !0 },
        ...
        init: function() {
          ...
          var e,
            t = this.wasCreatedByNetwork();
          (this.onConnected = this.onConnected.bind(this)),
            (this.syncData = {}),
            (this.componentSchemas = NAF.schemas.getComponents(
              this.data.template
            )),
            (this.cachedElements = new Array(this.componentSchemas.length)),
            (this.networkUpdatePredicates = this.componentSchemas.map(function(
              e
            ) {
              return (
                (e.requiresNetworkUpdate && e.requiresNetworkUpdate()) ||
                ((t = null),
                function(e) {
                  return !(
                    (null !== t && i(t, e)) ||
                    ((t = AFRAME.utils.clone(e)), 0)
                  );
                })
              );
              var t;
            ...
            "" === this.data.networkId
              ? ((e = NAF.utils.createNetworkId()),
                this.el.setAttribute(this.name, { networkId: e }))
              : (e = this.data.networkId),
            this.el.id || this.el.setAttribute("id", "naf-" + e),
            t
              ? this.firstUpdate()
              : (this.data.attachTemplateToLocal &&
        ...
        attachTemplateToLocal: function() {
          for (
            var e = NAF.schemas.getCachedTemplate(this.data.template),
              t = e.attributes,
              n = 0;
            n < t.length;
            n++
          )
            this.el.setAttribute(t[n].name, t[n].value);
          for (; e.firstElementChild; )
            this.el.appendChild(e.firstElementChild);
        },
        ...
        initNetworkParent: function() {
          ...
          e.components && e.components.networked
            ? (this.parent = e)
            : (this.parent = null);
        },
        ...
        applyPersistentFirstSync: function() {
          ...
          t &&
            (this.networkUpdate(t), NAF.entities.forgetPersistentFirstSync(e));
        },
          ...
          if (!this.isMine() && NAF.options.useLerp)
            for (var n = 0; n < this.bufferInfos.length; n++) {
              var i = this.bufferInfos[n],
                ...
                r = i.object3D,
                s = i.componentNames;
              if ((o.update(t), s.includes("position"))) {
                var c = o.getPosition();
                a(c) ? r.position.copy(c) : u(l, 5e3);
              }
              if (s.includes("rotation")) {
                var h = o.getQuaternion();
                !(f = h).isQuaternion ||
                isNaN(f.x) ||
                isNaN(f.y) ||
                isNaN(f.z) ||
        ...
        syncAll: function(e, t) {
          if (this.canSync()) {
            ...
            e
              ? NAF.connection.sendDataGuaranteed(e, "u", i)
              : NAF.connection.broadcastDataGuaranteed("u", i);
          }
        },
        syncDirty: function() {
          if (this.canSync()) {
        ...
        getCachedElement: function(e) {
          ...
          return n.selector
            ? (this.cachedElements[e] = this.el.querySelector(n.selector))
            : (this.cachedElements[e] = this.el);
        },
        invalidateCachedElements: function() {
          for (var e = 0; e < this.cachedElements.length; e++)
        ...
        gatherComponentsData: function(e) {
          for (var t = null, n = 0; n < this.componentSchemas.length; n++) {
            ...
            if (o) {
              var r = i.component ? i.component : i,
                s = o.getAttribute(r);
              if (null !== s) {
                var a = i.property ? s[i.property] : s;
                (this.networkUpdatePredicates[n](a) || e) &&
                  ((t = t || {})[n] = a);
              } else e && ((t = t || {})[n] = null);
            } else e && ((t = t || {})[n] = null);
          }
        ...
        createSyncData: function(e, t) {
          var n = this.syncData,
            i = this.data;
          return (
            (n.networkId = i.networkId),
            (n.owner = i.owner),
            (n.creator = i.creator),
            (n.lastOwnerTime = this.lastOwnerTime),
            (n.template = i.template),
            (n.persistent = i.persistent),
            (n.parent = this.getParentId()),
            (n.components = e),
            (n.isFirstSync = !!t),
            n
          );
        ...
        canSync: function() {
          ...
          for (var t in e) if (t === this.data.owner) return !1;
          return !0;
        },
        getParentId: function() {
          return (
            this.initNetworkParent(),
            this.parent ? this.parent.getAttribute("networked").networkId : null
          );
        },
        networkUpdate: function(e) {
          if (
            !(
              e.lastOwnerTime < this.lastOwnerTime ||
              (this.lastOwnerTime === e.lastOwnerTime &&
                this.data.owner > e.owner)
            ) &&
            void 0 !== this.data
          ) {
            if (this.data.owner !== e.owner) {
              ...
              var n = this.data.owner,
                i = e.owner;
              this.el.setAttribute("networked", { owner: e.owner }),
                t &&
                  ((this.onOwnershipLostEvent.newOwner = i),
                  this.el.emit(this.OWNERSHIP_LOST, this.onOwnershipLostEvent)),
                (this.onOwnershipChangedEvent.oldOwner = n),
                (this.onOwnershipChangedEvent.newOwner = i),
                this.el.emit(
                  this.OWNERSHIP_CHANGED,
                  this.onOwnershipChangedEvent
                );
            }
            this.data.persistent !== e.persistent &&
              this.el.setAttribute("networked", { persistent: e.persistent }),
        ...
        updateNetworkedComponents: function(e) {
          for (var t = 0, n = this.componentSchemas.length; t < n; t++) {
            var i = e[t],
              ...
              r = this.getCachedElement(t);
            null !== r &&
              null != i &&
              (o.component
                ? o.property
                  ? this.updateNetworkedComponent(r, o.component, o.property, i)
                  : this.updateNetworkedComponent(r, o.component, i)
                : this.updateNetworkedComponent(r, o, i));
          }
        },
        updateNetworkedComponent: function(e, t, n, i) {
          if (NAF.options.useLerp && s.includes(t)) {
            ...
            switch (t) {
              case "position":
                return void d.setPosition(
                  this.bufferPosition.set(n.x, n.y, n.z)
                );
              case "rotation":
                return (
                  this.conversionEuler.set(r * n.x, r * n.y, r * n.z),
                  void d.setQuaternion(
        ...
        remove: function() {
          if (this.isMine() && NAF.connection.isConnected()) {
            var e = { networkId: this.data.networkId };
            NAF.entities.hasEntity(this.data.networkId)
              ? NAF.connection.broadcastDataGuaranteed("r", e)
              : (this.data.creator &&
                  !1 ===
                    NAF.connection.activeDataChannels[this.data.creator]) ||
                NAF.log.error(
          ...
          NAF.entities.forgetEntity(this.data.networkId),
            document.body.dispatchEvent(
              this.entityRemovedEvent(this.data.networkId)
            ),
        ...
        entityRemovedEvent: function(e) {
          return new CustomEvent("entityRemoved", { detail: { networkId: e } });
        }
      });
  },
  function(e, t, n) {
    ...
    e.exports = function e(t, n) {
      ...
      if (t && n && "object" == i(t) && "object" == i(n)) {
        ...
        var v = r(t);
        if ((c = v.length) !== r(n).length) return !1;
        for (a = c; 0 != a--; ) if (!s.call(n, v[a])) return !1;
        for (a = c; 0 != a--; ) if (!e(t[(u = v[a])], n[u])) return !1;
        return !0;
      }
      return t != t && n != n;
    };
          ...
          i(e, [
            {
              ...
              value: function(e, t, n, i, o, r) {
                var s = t * t,
                  ...
                  l = a - 2 * s + t,
                  h = a - s;
                e.copy(n.multiplyScalar(c)),
                  e.add(i.multiplyScalar(u)),
                  e.add(o.multiplyScalar(l)),
                  e.add(r.multiplyScalar(h));
              }
            },
            {
              key: "lerp",
              ...
              value: function(e, t, n, i) {
                var o =
                  this.buffer.length > 0
                    ...
                    : null;
                if (o && o.time === this.time)
                  e && o.position.copy(e),
                    t && o.velocity.copy(t),
                    n && o.quaternion.copy(n),
                    i && o.scale.copy(i);
                else {
                  var r = o || this.originFrame,
                    a = s();
                  a.position.copy(e || r.position),
                    a.velocity.copy(t || r.velocity),
                    a.quaternion.copy(n || r.quaternion),
                    a.scale.copy(i || r.scale),
                    (a.time = this.time),
                    this.buffer.push(a);
                }
              }
                    ...
                    0 === this.mode
                      ...
                      : 1 === this.mode &&
                        this.hermite(
                          ...
                          this.originFrame.position,
                          n.position,
                          this.originFrame.velocity.multiplyScalar(i),
                          n.velocity.multiplyScalar(i)
                        ),
                      this.slerp(
                        this.quaternion,
                        this.originFrame.quaternion,
                        n.quaternion,
                        o
                      ),
                      this.lerp(this.scale, this.originFrame.scale, n.scale, o);
                  }
                }
    ...
    AFRAME.registerComponent("networked-audio-source", {
      ...
      init: function() {
        ...
        (this.listener = null),
          ...
          NAF.utils.getNetworkedEntity(this.el).then(function(t) {
            var n = t.components.networked.data.owner;
            n &&
              NAF.connection.adapter
                .getMediaStream(n)
                .then(e._setMediaStream)
                .catch(function(e) {
                  return i.log.error(
                    "Error getting media stream for ".concat(n),
                    e
                  );
                });
          });
        ...
        if ((this.sound || this.setupSound(), e != this.stream)) {
          if ((this.stream && this.sound.disconnect(), e)) {
            /chrome/i.test(navigator.userAgent) &&
              ...
              (this.audioEl.srcObject = e),
              (this.audioEl.volume = 0));
            var t = this.sound.context.createMediaStreamSource(e);
            this.sound.setNodeSource(t),
              this.el.emit("sound-source-set", { soundSource: t });
          }
          this.stream = e;
        }
      },
      ...
      remove: function() {
        this.sound &&
          ...
          this.stream && this.sound.disconnect());
      },
      setupSound: function() {
        var e = this.el,
          t = e.sceneEl;
        this.sound && e.removeObject3D(this.attrName),
          t.audioListener ||
            ((t.audioListener = new THREE.AudioListener()),
            t.camera && t.camera.add(t.audioListener),
            t.addEventListener("camera-set-active", function(e) {
              e.detail.cameraEl.getObject3D("camera").add(t.audioListener);
            })),
          (this.listener = t.audioListener),
          (this.sound = this.data.positional
            ? new THREE.PositionalAudio(this.listener)
            : new THREE.Audio(this.listener)),
          e.setObject3D(this.attrName, this.sound),
          this._setPannerProperties();
      }
    });
  },
  function(e, t, n) {
    ...
    AFRAME.registerComponent("networked-video-source", {
      ...
      _setMediaStream: function(e) {
        if ((this.video || this.setupVideo(), e != this.stream)) {
          if ((this.stream && this._clearMediaStream(), e)) {
            this.video.srcObject = e;
            var t = this.video.play();
            t instanceof Promise &&
              t.catch(function(e) {
                return i.log.error("Error play video stream", e);
              }),
              this.videoTexture && this.videoTexture.dispose(),
              (this.videoTexture = new THREE.VideoTexture(this.video));
            var n = this.el.getObject3D("mesh");
            (n.material.map = this.videoTexture), (n.material.needsUpdate = !0);
          }
          this.stream = e;
        }
      },
      _clearMediaStream: function() {
        if (((this.stream = null), this.videoTexture)) {
          if (this.videoTexture.image instanceof HTMLVideoElement) {
            var e = this.videoTexture.image;
            e.pause(), (e.srcObject = null), e.load();
          }
