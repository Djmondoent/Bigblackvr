          ...
          getMediaStream(clientId, type = "audio") {
            if (this.mediaStreams[clientId]) {
              ...
              if (!this.pendingMediaRequests.has(clientId)) {
                ...
                this.pendingMediaRequests.get(
                  clientId
                ).audio.promise = audioPromise;
                this.pendingMediaRequests.get(
                  clientId
                ).video.promise = videoPromise;
