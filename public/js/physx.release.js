  ...
  return function (PHYSX) {
    ...
    if (!Object.getOwnPropertyDescriptor(Module["ready"], "___data_end")) {
      Object.defineProperty(Module["ready"], "___data_end", {
        ...
        get: function () {
          abort(
            "You are getting ___data_end on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js"
          );
        },
      });
      Object.defineProperty(Module["ready"], "___data_end", {
        ...
        set: function () {
          abort(
            "You are setting ___data_end on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js"
          );
        },
      });
    }
    ...
    if (!Object.getOwnPropertyDescriptor(Module["ready"], "_memcpy")) {
      Object.defineProperty(Module["ready"], "_memcpy", {
        ...
        get: function () {
          abort(
            "You are getting _memcpy on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js"
          );
        },
      });
      Object.defineProperty(Module["ready"], "_memcpy", {
        ...
        set: function () {
          abort(
            "You are setting _memcpy on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js"
          );
        },
      });
    }
    ...
    var STACK_BASE = 5431632,
      STACK_MAX = 188752,
      DYNAMIC_BASE = 5431632,
      DYNAMICTOP_PTR = 188592;
    ...
    var dynCall_iiiff = (Module["dynCall_iiiff"] =
      createExportWrapper("dynCall_iiiff"));
    var dynCall_iiifff = (Module["dynCall_iiifff"] =
      createExportWrapper("dynCall_iiifff"));
    ...
    var dynCall_iiiiiifiiiiif = (Module["dynCall_iiiiiifiiiiif"] =
      createExportWrapper("dynCall_iiiiiifiiiiif"));
    ...
    var dynCall_iiffff = (Module["dynCall_iiffff"] =
      createExportWrapper("dynCall_iiffff"));
    var dynCall_viiif = (Module["dynCall_viiif"] =
      createExportWrapper("dynCall_viiif"));
    var dynCall_iiiiffii = (Module["dynCall_iiiiffii"] =
      createExportWrapper("dynCall_iiiiffii"));
    var dynCall_iiiif = (Module["dynCall_iiiif"] =
      createExportWrapper("dynCall_iiiif"));
...
else if (typeof exports === "object") exports["PHYSX"] = PHYSX;
