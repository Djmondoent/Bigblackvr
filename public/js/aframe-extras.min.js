              ...
              l(ee, "library_animations", "animation", function(e) {
                ...
                (function() {
                  ...
                  if (void 0 !== t && void 0 !== i) {
                    for (
                      var o = (function(e) {
                          return u(ce.kinematicsModels[e], D);
                        })(t),
                        s = (function(e) {
        ...
        t.exports = AFRAME.registerComponent("gamepad-controls", {
          ...
          isVelocityActive: function() {
            ...
            var e = this._dpadVector,
              t = this._moveVector;
            this.getDpad(e), this.getJoystick(s.MOVEMENT, t);
            var i = e.x || t.x,
              n = e.y || t.y;
          ...
          updateRotation: function(e) {
            if (this.isRotationActive()) {
              ...
              var a = this._lookVector;
              this.getJoystick(s.ROTATION, a),
                Math.abs(a.x) <= 0.2 && (a.x = 0),
                Math.abs(a.y) <= 0.2 && (a.y = 0),
                a.multiplyScalar((t.rotationSensitivity * e) / 1e3),
                (i.rotation.y -= a.x),
                (n.rotation.x -= a.y),
          ...
          getGamepad: (function() {
            var e = [],
              t = [];
            return function(i) {
              var n = this.el.sceneEl.components["proxy-controls"],
                r = n && n.isConnected() && n.getGamepad(0);
              if (r) return r;
              e.length = 0;
              for (var o = 0; o < this.system.controllers.length; o++) {
                var s = this.system.controllers[o],
                  a = s ? s.gamepad : null;
                if ((e.push(a), a && a.handedness === i)) return a;
              }
              for (
                var c = navigator.getGamepads ? navigator.getGamepads() : t,
                  l = 0;
                l < c.length;
                l++
              ) {
                var h = c[l];
                if (h && h.hand === i) return h;
              }
              return e[0] || c[0];
            };
          })(),
          getButton: function(e) {
            return this.getGamepad(o.RIGHT).buttons[e];
          },
          getAxis: function(e) {
            return this.getGamepad(e > 1 ? o.RIGHT : o.LEFT).axes[e];
          },
          getJoystick: function(e, t) {
            var i = this.getGamepad(e === s.MOVEMENT ? o.LEFT : o.RIGHT);
