  ...
  var core = function() {
    ...
    describe("this enclosure", function() {
      ...
      it("should have reasonable dimensions", function() {
        expect(enclosure)
          .to.have.a.property("innerWidth")
          .which.is.within(1, 4096);
        expect(enclosure)
          .to.have.a.property("innerHeight")
          .which.is.within(1, 4096);
        expect(enclosure)
          .to.have.a.property("innerDepth")
          .which.is.within(1, 4096);
      });

      it("should have a reasonable pixelsPerMeter", function() {
        expect(enclosure)
          .to.have.a.property("pixelsPerMeter")
          .which.is.within(0.001, 1000000);
      });
    ...
    describe("this user", function() {
      ...
      it("should have a displayName", function() {
        expect(user)
          .to.have.a.property("displayName")
          .which.is.a("string")
          .and.is.not.equal("");
      });
    ...
    describe("the tracking skeleton", function() {
      ...
      it("should have joints", function() {
        ...
        expect(trackingSkeleton)
          .to.have.a.property("children")
          .which.has.a.property("length")
          .which.is.above(0);
      });

      it("should have a joint getter supporting default properties", function() {
        expect(trackingSkeleton.getJoint("Eye")).to.equal(
          trackingSkeleton.getJoint("Eye", "Center", 0)
        );
      });
      ...
      it("should have a center eye with some confidence", function() {
        ...
        expect(centerEye)
          .to.exist.and.to.have.a.property("confidence")
      ...
      it("should return the same skeleton for subsequent calls", function() {
        ...
        ).to.eventually.equal(trackingSkeleton);
      });
    });
