...
AFRAME.registerComponent("controller-listener", {
  ...
  tick: function () {
    ...
    if (this.leftTrigger.pressed && this.rightTrigger.pressed) {
      this.enableFlying();
    } else if (this.leftTrigger.released || this.rightTrigger.released) {
      this.disableFlying();
    }
  },
  ...
  enableFlying: function () {
    ...
    cameraRig.setAttribute("movement-controls", "type: flying");
  },

  disableFlying: function () {
    const cameraRig = document.querySelector("#camera-rig");
    cameraRig.setAttribute("movement-controls", "type: walking");
  },
});
