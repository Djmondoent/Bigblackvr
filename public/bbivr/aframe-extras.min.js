      ...
      tick: function(t, e) {
        ...
        if (i) {
          if (!this.el.is("endofpath")) {
            ...
            if (
              ((r =
                this.interval - this.data.delay >= this.data.dur
                  ? 1
                  : this.interval - this.data.delay < 0
                  ? 0
                  : (this.interval - this.data.delay) / this.data.dur),
              this.data.loop === !1 && r >= 1)
            )
            ...
            if (this.data.rotate === !0) {
              var s = new THREE.Vector3(),
                ...
                g = i.getTangentAt(r).normalize();
              s.crossVectors(o, g).normalize();
              var n = Math.acos(o.dot(g));
              this.el.object3D.quaternion.setFromAxisAngle(s, n);
            }
            this.triggers &&
